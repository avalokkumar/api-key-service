...
public class ApiKeyRequest {
    ...
    private String clientEmail; // The email address of the client requesting the API key.

    @JsonProperty(value = "client_description")
    private String clientDescription; // A brief description of the client and their intended use of the API key.
